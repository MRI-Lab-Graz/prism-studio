#!/usr/bin/env python3
"""
Comprehensive demonstration of the prism with schema versioning
"""
...
def main():
    ...
    if not os.path.exists("prism.py"):
        print("❌ Error: Please run from the prism directory")
        sys.exit(1)
