...
def fix_participants_tsv(
    ...
    try:
                ...
                try:
                    ...
                    if numeric_count > 0:
                        ...
                        if str(original_sample) != str(new_sample):
                            ...
                            print(f"✓ Fixed '{col}': converted {numeric_count} values from strings to numbers")
        ...
        import csv
        df.to_csv(output_path, sep="\t", index=False, na_rep='n/a', quoting=csv.QUOTE_NONE, escapechar='\\')
