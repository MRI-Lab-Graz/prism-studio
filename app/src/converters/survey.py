...
def _convert_survey_dataframe_to_prism_dataset(
    *,
    ...
    # written to a separate task-systemmeta file, not mixed with questionnaire data
...
def _write_limesurvey_sidecar(
    ...
    """Write the root-level task-systemmeta_survey.json sidecar.
    ...
    sidecar_path = dataset_root / "task-systemmeta_survey.json"
...
def _write_limesurvey_data(
    *,
    ...
    # Write TSV
    filename = f"{sub_id}_{ses_id}_task-systemmeta_survey.tsv"
