...
MODALITY_PATTERNS = {
    ...
    # The recording- label is free-form (ecg, cardiac, puls, resp, eda, ppg, emg,
    # temp, bp, spo2, trigger, ...); [a-zA-Z0-9]+ already covers all of these,
    # so no enumerated alternation is needed.
    "physio": r".+(_recording-[a-zA-Z0-9]+)?_physio\.(tsv|tsv\.gz|json|edf)$",
    "physiological": r".+(_recording-[a-zA-Z0-9]+)?_physio\.(tsv|tsv\.gz|json|edf)$",
