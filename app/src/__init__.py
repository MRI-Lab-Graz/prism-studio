...
try:
    ...
    # Bundled layout under onedir: canonical backend is copied to
    # <bundle_root>/backend_bundle/src. This path must be visible both in
    # frozen runtime and in plain-Python smoke checks against bundle files.
