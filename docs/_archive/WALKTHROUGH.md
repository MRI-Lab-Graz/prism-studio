...
Welcome to PRISM (Principled Research Information & Sidecar Model). This guide will walk you through everything from installation to generating your first validated dataset and manuscript boilerplate.
