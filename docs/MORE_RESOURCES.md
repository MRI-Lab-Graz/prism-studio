...
<div class="prism-chapter-grid prism-chapter-grid--amber">
  <a class="prism-chapter-card" href="WORKSHOP.html">
    <span class="prism-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="12" rx="1"/><path d="M8 20h8"/><path d="M12 16v4"/><path d="M7 9l3 2 2-3 4 3"/></svg></span>
    <span class="prism-chapter-title">Workshop</span>
    <span class="prism-chapter-outcome">One concrete end-to-end example, packaged for a live session</span>
  </a>
  <a class="prism-chapter-card" href="EXAMPLES.html">
    <span class="prism-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 21h4"/><path d="M12 3a6 6 0 0 0-4 10.5c.6.6.9 1 .9 1.8V16h6.2v-.7c0-.8.3-1.2.9-1.8A6 6 0 0 0 12 3Z"/></svg></span>
    <span class="prism-chapter-title">Examples</span>
    <span class="prism-chapter-outcome">Learning PRISM Studio by doing rather than reading reference pages</span>
  </a>
