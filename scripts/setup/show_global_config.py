...
def main():
    ...
    if lib_paths['global_library_path'] and os.path.exists(lib_paths['global_library_path']):
    ...
    if lib_paths['global_recipe_path'] and os.path.exists(lib_paths['global_recipe_path']):
