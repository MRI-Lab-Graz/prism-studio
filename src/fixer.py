...
class DatasetFixer:
    ...
    def _check_missing_sidecars(self):
        ...
        for root, dirs, files in os.walk(self.dataset_path):
            ...
            dirs[:] = [d for d in dirs if not d.startswith(".") and d not in ["code", "derivatives", "sourcedata"]]
    ...
    def _infer_modality(self, file_path: str, filename: str) -> str:
        ...
        if "/survey/" in path_lower or "_survey-" in name_lower:
            ...
            return "physio"
        elif "/eyetrack" in path_lower or "_eyetrack" in name_lower or "_eye" in name_lower:
            return "eyetracking"
    ...
    def _create_sidecar_stub(self, modality: str, filename: str) -> Dict[str, Any]:
        ...
        if modality == "survey":
            ...
            return {
                "Technical": {
                    "StimulusType": "Assessment",
                    "FileFormat": "tsv"
                },
                "Study": {
                    "TaskName": "TODO",
                    "OriginalName": "TODO: Assessment name"
                },
                "Metadata": {
                    "SchemaVersion": "1.0.0",
                    "CreationDate": today
