# survey-gad7 - Pavlovia Experiment

This experiment was automatically generated from PRISM survey data.

## Files

- `survey-gad7.psyexp`: PsychoPy Builder experiment file
...
2. Open `survey-gad7.psyexp` in PsychoPy Builder
...
```bash
python src/converters/pavlovia.py --import pavlovia_data.csv task-survey-gad7_beh.json
```
