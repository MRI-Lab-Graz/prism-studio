...
from src.converters.survey_participants_logic import (
    ...
    _merge_with_existing_participants_tsv,
)
...
def test_builds_participant_id_column_from_normalized_id():
    ...
    result = _build_participant_output_dataframe(
        df=df,
        id_col="id",
        normalize_sub_fn=_identity_normalize_sub,
        is_missing_fn=_never_missing,
        missing_token="n/a",
...
def test_extra_columns_are_included_and_renamed():
    ...
    column_plan = ParticipantColumnPlan(
        extra_cols=["income"],
        col_output_names={"income": "sociodem_income"},
        mapping_descriptions={},
        value_mappings={},
        template_norm=None,
    )
...
def test_missing_values_become_the_missing_token():
    ...
    column_plan = ParticipantColumnPlan(
        extra_cols=["income"],
        col_output_names={"income": "income"},
        mapping_descriptions={},
        value_mappings={},
        template_norm=None,
    )
...
def test_value_mapping_transforms_values():
    ...
    column_plan = ParticipantColumnPlan(
        extra_cols=["sex"],
        col_output_names={"sex": "sex"},
        mapping_descriptions={},
        value_mappings={"sex": {"1": "male", "2": "female"}},
        template_norm=None,
    )
