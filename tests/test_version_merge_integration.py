...
class TestVersionMergeIntegration:
    ...
    def test_xlsx_import_with_version_merge(self, tmp_path):
        ...
        print("  Items: BDI_01 through BDI_05")
        ...
        print("  Items: BDI_01 through BDI_10")
        ...
        def mock_merge_handler(existing_template_path, new_items, prefix):
            ...
            print(
                f"  [Handler called] Existing: {existing_template_path.name}, Items: {len(new_items)}, Prefix: {prefix}"
            )
        ...
        print("✓ Import completed with merge")
        ...
        print("✓ Overlapping items have both versions (BDI_01 to BDI_05)")
        ...
        print("✓ New items only have long version (BDI_06 to BDI_10)")
