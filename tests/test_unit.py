...
from issues import (
    Issue, Severity, create_issue, error, warning, info,
    tuple_to_issue, issues_to_dict, summarize_issues, ERROR_CODES
)
...
class TestValidatorIntegration:
    ...
    def test_validate_missing_dataset_description(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert any("dataset_description.json" in msg.lower() for msg in error_messages)
