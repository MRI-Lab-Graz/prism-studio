...
DISPATCH_CASES = [
    ...
    (dict(command="participants", action="fix-bids"), "participants_fix_bids"),
    (dict(command="survey", action="import-lsq"), "survey_import_lsq"),
    (dict(command="dataset", action="rename-sessions"), "dataset_rename_sessions"),
    (dict(command="dataset", action="renumber-runs"), "dataset_renumber_runs"),
    (dict(command="dataset", action="undo"), "dataset_undo"),
    (dict(command="recipes", kind="save"), "recipes_save"),
